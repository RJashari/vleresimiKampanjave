...
@NamedQueries({
    ...
    , @NamedQuery(name = "Pytesori.countPytja1TV", query = "SELECT COUNT(p) FROM Pytesori p WHERE p.pytja1TV = true")   
    , @NamedQuery(name = "Pytesori.countPytja1Radio", query = "SELECT COUNT(p) FROM Pytesori p WHERE p.pytja1Radio = true")
    , @NamedQuery(name = "Pytesori.countPytja1RrjeteSociale", query = "SELECT COUNT(p) FROM Pytesori p WHERE p.pytja1RrjeteSociale = true")
    , @NamedQuery(name = "Pytesori.countPytja1Billboards", query = "SELECT COUNT(p) FROM Pytesori p WHERE p.pytja1Billboards = true")
    , @NamedQuery(name = "Pytesori.countPytja1Gazete", query = "SELECT COUNT(p) FROM Pytesori p WHERE p.pytja1Gazete = true")
    , @NamedQuery(name = "Pytesori.countPytja1Portale", query = "SELECT COUNT(p) FROM Pytesori p WHERE p.pytja1Portale = true")
    , @NamedQuery(name = "Pytesori.countPytja1Referuar", query = "SELECT COUNT(p) FROM Pytesori p WHERE p.pytja1Referuar = true")
    , @NamedQuery(name = "Pytesori.countPytja1PromovimetDirekte", query = "SELECT COUNT(p) FROM Pytesori p WHERE p.pytja1PromovimetDirekte = true")
    , @NamedQuery(name = "Pytesori.countPytja1SMS", query = "SELECT COUNT(p) FROM Pytesori p WHERE p.pytja1SMS = true")
        
    , @NamedQuery(name = "Pytesori.countPytja2TV", query = "SELECT COUNT(p) FROM Pytesori p WHERE p.pytja2TV = true")   
    , @NamedQuery(name = "Pytesori.countPytja2Radio", query = "SELECT COUNT(p) FROM Pytesori p WHERE p.pytja2Radio = true")
    , @NamedQuery(name = "Pytesori.countPytja2RrjeteSociale", query = "SELECT COUNT(p) FROM Pytesori p WHERE p.pytja2RrjeteSociale = true")
    , @NamedQuery(name = "Pytesori.countPytja2Billboards", query = "SELECT COUNT(p) FROM Pytesori p WHERE p.pytja2Billboards = true")
    , @NamedQuery(name = "Pytesori.countPytja2Gazete", query = "SELECT COUNT(p) FROM Pytesori p WHERE p.pytja2Gazete = true")
    , @NamedQuery(name = "Pytesori.countPytja2Portale", query = "SELECT COUNT(p) FROM Pytesori p WHERE p.pytja2Portale = true")
    , @NamedQuery(name = "Pytesori.countPytja2Referuar", query = "SELECT COUNT(p) FROM Pytesori p WHERE p.pytja2Referuar = true")
    , @NamedQuery(name = "Pytesori.countPytja2PromovimetDirekte", query = "SELECT COUNT(p) FROM Pytesori p WHERE p.pytja2PromovimetDirekte = true")
    , @NamedQuery(name = "Pytesori.countPytja2SMS", query = "SELECT COUNT(p) FROM Pytesori p WHERE p.pytja2SMS = true")
